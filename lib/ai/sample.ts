...
const CATALOG_KEYWORDS: (ExtractedCatalogItem & { match: RegExp })[] = [
  { match: /flat[\s-]?top|griddle/i, name: "Flat-top griddle", category: "cooking", length_ft: 3, depth_ft: 2.2, height_ft: 1.5, unit_price: 2200, power_watts: 0, weight_lbs: 180, tags: ["gas"], notes: "" },
  { match: /\bfryer\b/i, name: "Deep fryer", category: "cooking", length_ft: 1.5, depth_ft: 2.2, height_ft: 3, unit_price: 1600, power_watts: 0, weight_lbs: 120, tags: ["gas"], notes: "" },
  { match: /6[\s-]?burner|range\b/i, name: "6-burner range + oven", category: "cooking", length_ft: 3, depth_ft: 2.4, height_ft: 3, unit_price: 3800, power_watts: 0, weight_lbs: 400, tags: ["gas"], notes: "" },
  { match: /char[\s-]?broiler|char grill/i, name: "Charbroiler", category: "cooking", length_ft: 2, depth_ft: 2.2, height_ft: 1.5, unit_price: 1900, power_watts: 0, weight_lbs: 200, tags: ["gas"], notes: "" },
  { match: /vent hood|exhaust hood|hood\b/i, name: "Commercial vent hood", category: "ventilation", length_ft: 6, depth_ft: 2.5, height_ft: 1.2, unit_price: 6900, power_watts: 600, weight_lbs: 350, tags: ["fire-suppression"], notes: "" },
  { match: /reach[\s-]?in|refrigerator|fridge/i, name: "Reach-in refrigerator", category: "refrigeration", length_ft: 2.5, depth_ft: 2.6, height_ft: 6.5, unit_price: 3400, power_watts: 800, weight_lbs: 320, tags: [], notes: "" },
  { match: /freezer/i, name: "Reach-in freezer", category: "refrigeration", length_ft: 2.5, depth_ft: 2.6, height_ft: 6.5, unit_price: 3900, power_watts: 1000, weight_lbs: 340, tags: [], notes: "" },
  { match: /under[\s-]?counter (fridge|refrigerat)/i, name: "Undercounter refrigeration", category: "refrigeration", length_ft: 3, depth_ft: 2.4, height_ft: 3, unit_price: 2600, power_watts: 600, weight_lbs: 200, tags: [], notes: "" },
  { match: /3[\s-]?comp|three[\s-]?comp|compartment sink/i, name: "3-compartment sink", category: "sink", length_ft: 4, depth_ft: 2, height_ft: 3, unit_price: 1400, power_watts: 0, weight_lbs: 150, tags: [], notes: "" },
  { match: /hand[\s-]?sink|hand wash/i, name: "Hand sink", category: "sink", length_ft: 1.2, depth_ft: 1.2, height_ft: 3, unit_price: 350, power_watts: 0, weight_lbs: 40, tags: [], notes: "" },
  { match: /prep table|stainless table|work table/i, name: "Stainless prep table", category: "prep", length_ft: 4, depth_ft: 2.2, height_ft: 3, unit_price: 700, power_watts: 0, weight_lbs: 90, tags: [], notes: "" },
  { match: /espresso/i, name: "Dual-group espresso machine", category: "cooking", length_ft: 2.5, depth_ft: 2, height_ft: 1.5, unit_price: 9500, power_watts: 3000, weight_lbs: 150, tags: ["electric"], notes: "" },
  { match: /grinder/i, name: "Coffee grinder", category: "prep", length_ft: 0.7, depth_ft: 0.7, height_ft: 1.5, unit_price: 800, power_watts: 500, weight_lbs: 25, tags: ["electric"], notes: "" },
  { match: /generator/i, name: "Onboard generator", category: "equipment", length_ft: 2.5, depth_ft: 2, height_ft: 2, unit_price: 6200, power_watts: 0, weight_lbs: 400, tags: ["power"], notes: "" },
];
